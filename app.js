...
const app = express();
const {getTopics,checkReq,getApi,getArticleId,getArticles,getCommentsForArticleId,postCommentForArticleId,patchArticleById,deleteCommentById} = require('./controllers/mainController')
